...
public class VillagesAnimations {
    ...
    public static final AnimationBuilder LUMBERJACK_CHOP_TREE = new AnimationBuilder().addAnimation("animation.villages:lumberjack.chop_tree", true);
    public static final AnimationBuilder LUMBERJACK_PLANT_SAPLING = new AnimationBuilder().addAnimation("animation.villages:lumberjack.plant", true);
