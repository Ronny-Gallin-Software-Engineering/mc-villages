...
import static de.rgse.mc.villages.world.VillagesPOITypes.CAMPING_SITE_BLOCKS;
...
public class MoveToCampfireGoal extends MoveToTargetPosGoal {
    ...
    private List<BlockPos> getNearbyCampfires() {
        ...
        Stream<PointOfInterest> stream = pointOfInterestStorage.getInCircle(pointOfInterestType -> pointOfInterestType == VillagesPOITypes.CAMPING_SITE, blockPos, RANGE, PointOfInterestStorage.OccupationStatus.ANY);
