...
public class VillagesSensors {
    ...
    public static final SensorType<POISensor> CRAFTING_TABLE_SENSOR = SensorTypeAccessor.register(IdentifierUtil.createString("poi_senor"), () -> new POISensor(VillagesPOI.CRAFTING_TABLE));
